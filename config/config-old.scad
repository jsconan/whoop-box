...
layerHeight = 0.2;  // the target layer height
nozzleWidth = 0.4;           // the size of the print nozzleWidth
printTolerance = 0.1;     // the distance between the walls of two objects

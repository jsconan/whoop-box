 ...
 *
 * Shows a complete angled box container.
 *
 * @author jsconan
 */
...
applyMode(mode=renderMode) {
    ...
    translateY(-getBoxWidth(motorDistance=motorDistance, ductDiameter=ductDiameter, wallThickness=containerThickness, wallDistance=getWallDistance(wallThickness=wallThickness)) / 2) {
